...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <a href="/spk_eo/public/admin" class="get-started-btn scrollto">SPK</a>
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover">
                            <tbody><tr>
                              ...
                              <td class="details text-right"><a href="/spk_eo/public/details" class="details-btn scrollto">Details</a></td>
                            </tr>
                            <tr>
