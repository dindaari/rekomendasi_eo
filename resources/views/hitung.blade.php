              ...
              <div class="card-body">
                ...
                @foreach ($data as $alternatif)
                    <tr>
                        ...
                        <td>{{$alternatif->kriteria_3 / $C3min['alternatif']}}</td>
                ...
                @foreach ($data as $alternatif)
                    <tr>
                        ...
                        <td>
                            ...
                            (($alternatif->kriteria_2 / $C2min['alternatif'])*$widget2['kriteria'])+
                            (($alternatif->kriteria_3 / $C3min['alternatif'])*$widget3['kriteria'])+
