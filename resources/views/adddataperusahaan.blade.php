  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Perusahaan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Add Perusahaan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Add Perusahaan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ url('/perusahaan/store')}}" class="form-horizontal">
                @csrf
                <div class="card-body">
                <div class="form-group row">
                    <label for="kode_alternatif" class="col-sm-2 col-form-label">Kode Alternatif</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="kode_alternatif" placeholder="Masukkan Alternatif">
                  </div>
                </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="alamat" placeholder="Masukan Alamat Perusahaan" >
                    </div>
                  </div>
                  <!-- <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="total_pelanggan" placeholder="Jumlah Total Pelanggan" >
                    </div>
                  </div> -->
                </div>
                <!-- /.card-body -->
